...
global.owner = process.env.OWNER_NUMBER  || '2348057243217' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "2348057243217" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"Freezer",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '18_04_2024_SIGMA_MD_8m7KLtdS_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'FREEZER',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `PRINCESS`, // ADD YOUR NAME
